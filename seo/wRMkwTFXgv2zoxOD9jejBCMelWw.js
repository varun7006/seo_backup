;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="a6c0130c6192bf95db1b048eb440af83";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){CloudflareApps.internal=CloudflareApps.internal||{};var errors=[];CloudflareApps.internal.placementErrors=errors;var errorHashes={}
...
return false;}})();;CloudflareApps.installs["bPNAozZHIPPY"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["bPNAozZHIPPY"].options={"id":"UA-92643213-2","social":true};;if(CloudflareApps.matchPage(CloudflareApps.installs['bPNAozZHIPPY'].URLPatterns)){(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');};if(CloudflareApps.matchPage(CloudflareApps.installs['bPNAozZHIPPY'].URLPatterns)){(function(){var options=CloudflareApps.installs['bPNAozZHIPPY'].options
